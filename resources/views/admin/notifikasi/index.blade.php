...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.dashboard') }}" class="btn btn-sm btn-outline-secondary shadow-sm">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div id="notifikasi-container">
                ...
                <div class="card mb-3 notification-card {{ $notif->kategori_notifikasi == 'emisi_karbon' ? 'notification-emisi' : ($notif->kategori_notifikasi == 'status_emisi' ? 'notification-status' : 'notification-kompensasi') }}">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="card-title mb-0">
                                @if($notif->kategori_notifikasi == 'emisi_karbon')
                                <i class="bi bi-cloud-plus text-info me-2"></i>Input Emisi Karbon Baru
                                @elseif($notif->kategori_notifikasi == 'status_emisi')
                                <i class="bi bi-check-circle text-warning me-2"></i>Perubahan Status Emisi
                                @else
                                <i class="bi bi-currency-exchange text-purple me-2"></i>Kompensasi Emisi Baru
                                @endif
                            </h5>
...
<script>
    ...
    function updateNotifikasiUI(notifikasi) {
        ...
        notifikasi.forEach(notif => {
            const kategoriClass = notif.kategori_notifikasi === 'emisi_karbon' ? 'notification-emisi' : 
                                (notif.kategori_notifikasi === 'status_emisi' ? 'notification-status' : 'notification-kompensasi');
            ...
            if (notif.kategori_notifikasi === 'emisi_karbon') {
                ...
                icon = '<i class="bi bi-currency-exchange text-purple me-2"></i>';
