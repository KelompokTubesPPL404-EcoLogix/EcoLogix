...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 border-0">
        <div class="card-header py-3 eco-gradient">
            <h6 class="m-0 font-weight-bold text">Form Pembelian Carbon Credit</h6>
        </div>
        <div class="card-body">
            @if(session('error'))
            ...
            @if(isset($noCompensations) && $noCompensations)
            <div class="alert alert-warning">
                <i class="bi bi-exclamation-triangle"></i> Tidak ada data kompensasi emisi yang tersedia dengan status "Belum Terkompensasi". Silahkan buat data kompensasi emisi terlebih dahulu.
            </div>
            @endif

            @if(isset($noProviders) && $noProviders)
            <div class="alert alert-warning">
                <i class="bi bi-exclamation-triangle"></i> Tidak ada penyedia carbon credit yang aktif. Silahkan hubungi administrator untuk menambahkan penyedia.
            </div>
            @endif
            ...
            <form action="{{ route('admin.carbon-credit-purchase.store') }}" method="POST" enctype="multipart/form-data" id="purchaseForm">
                ...
                <div class="form-section">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="kode_kompensasi" id="kode_kompensasi" class="form-select" required {{ isset($noCompensations) && $noCompensations ? 'disabled' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="kode_penyedia" id="kode_penyedia" class="form-select" required {{ isset($noProviders) && $noProviders ? 'disabled' : '' }}>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="jumlah_kompensasi" id="jumlah_kompensasi" class="form-control" step="0.01" min="0.01" value="{{ old('jumlah_kompensasi', '0.00') }}" readonly required>
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        ...
                        <button type="submit" class="btn btn-success" {{ (isset($noCompensations) && $noCompensations) || (isset($noProviders) && $noProviders) ? 'disabled' : '' }}>
