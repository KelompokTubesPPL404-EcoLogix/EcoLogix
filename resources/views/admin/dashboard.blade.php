                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Anda login sebagai Admin untuk perusahaan {{ Auth::user()->perusahaan->nama_perusahaan ?? 'Unknown' }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4 border-0 shadow-sm">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.emisicarbon.index') }}" class="btn btn-sm btn-outline-success rounded-pill">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="text-center mb-3">
                                ...
                                <h4 class="mt-2 mb-0">{{ $dashboardStats['pending_count'] }}</h4>
                        ...
                        <div class="col-md-4">
                            <div class="text-center mb-3">
                                ...
                                <h4 class="mt-2 mb-0">{{ $dashboardStats['approved_count'] }}</h4>
                        ...
                        <div class="col-md-4">
                            <div class="text-center mb-3">
                                ...
                                <h4 class="mt-2 mb-0">{{ $dashboardStats['rejected_count'] }}</h4>
