...
<head>
    ...
    <title>Tambah Staff - Sistem Manajemen Carbon Credit</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('admin.staff.index') }}">Staff</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.staff.store') }}" method="POST">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-info">Simpan Staff</button>
