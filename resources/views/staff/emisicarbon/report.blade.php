...
<head>
    <meta charset="utf-8">
    <title>Laporan Data Emisi Karbon</title>
    <style>
        body {
...
<body>
    <div class="content-wrapper">
        <div class="header">
            <h1>Laporan Data Emisi Karbon</h1>
            <p>Tanggal Cetak: {{ date('d/m/Y') }}</p>
        </div>

        <div class="meta-info">
            <p><strong>Nomor Dokumen:</strong> EMC-RPT-{{ date('Ymd-His') }}</p>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-badge status-{{ $emisi->status }}">
