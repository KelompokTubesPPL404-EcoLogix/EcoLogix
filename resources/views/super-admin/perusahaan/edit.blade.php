                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        <select class="form-select @error('kode_super_admin') is-invalid @enderror" id="kode_super_admin" name="kode_super_admin" required>
                            ...
                            <option value="{{ $admin->kode_user }}" {{ (old('kode_super_admin', $perusahaan->kode_super_admin) == $admin->kode_user) ? 'selected' : '' }}>{{ $admin->nama }} - {{ $admin->kode_user }}</option>
                            @endforeach
                        </select>
                    ...
                    <small class="form-text text-muted mt-1">
                        <i class="bi bi-info-circle me-1"></i>Super Admin yang bertanggung jawab atas perusahaan ini
                    </small>
                </div>
            </div>
