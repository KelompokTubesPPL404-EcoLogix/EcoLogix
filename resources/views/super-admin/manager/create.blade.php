...
<head>
    ...
    <title>Tambah Manager - Sistem Manajemen Carbon Credit</title>
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Tambah Manager untuk {{ $perusahaan->nama_perusahaan }}</h4>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('superadmin.manager.store') }}" method="POST">
                            @csrf
                            <input type="hidden" name="kode_perusahaan" value="{{ $perusahaan->kode_perusahaan }}">
