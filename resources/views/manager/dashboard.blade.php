    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card shadow mb-4">
                ...
                @php
                // Fungsi untuk mendapatkan data emisi berdasarkan periode (default 1 tahun)
                function getYearlyEmissionData() {
                    $user = Auth::user();
                ...
                // Ambil data emisi tahunan
                $yearlyData = getYearlyEmissionData();
                @endphp
                    ...
                    window.emisiChart = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: chartData.data.map(value => value / 1000), // Convert kg to ton
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getCategoryData() {
        ...
        // Hitung total emisi
        $totalEmisi = \App\Models\EmisiKarbon::where('kode_staff', 'like', $kodePerusahaan . '%')->sum('kadar_emisi_karbon');
    ...
    window.sumberEmisiChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                data: {!! json_encode($categoryData['data']) !!}.map(value => value / 1000), // Convert kg to ton
