                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ \Carbon\Carbon::parse($item->tanggal_emisi)->format('d M Y') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ \Carbon\Carbon::parse($row->tanggal_kompensasi)->format('d M Y') }}</td>
