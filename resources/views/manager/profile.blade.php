                    ...
                    <div class="card-body p-4">
                        ...
                        <form id="profile-form">
                            <div class="mb-3 text-center">
                                <img id="profile-photo" src="images/default-profile.png" alt="Foto Profil" class="rounded-circle mb-3" style="width: 120px; height: 120px; object-fit: cover;">
                            </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <a href="#" class="btn btn-outline-secondary px-5">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
