            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 d-flex">
                        <a href="{{ route('manager.faktor-emisi.edit', $faktorEmisi->kode_faktor) }}" class="btn btn-warning me-2">Edit</a>
                        <form action="{{ route('manager.faktor-emisi.destroy', $faktorEmisi->kode_faktor) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                            @csrf
                            @method('DELETE')
