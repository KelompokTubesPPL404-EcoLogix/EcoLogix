...
<head>
    ...
    <title>@yield('title', 'Manajemen Perusahaan')</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('perusahaan.index') }}">Manajemen Perusahaan</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('perusahaan.create') }}">Tambah Perusahaan</a>
                        </li>
                    </ul>
                </div>
            </div>
