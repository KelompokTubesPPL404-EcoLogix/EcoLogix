...
class PembelianCarbonCreditController extends Controller
{
    ...
    {
        return view('carbon_credit.reports');
    }

    public function myPurchases()
    {
        $pengguna = Auth::guard('pengguna')->user();
        $purchases = PembelianCarbonCredit::where('kode_user', $pengguna->kode_user)
            ->with('penyediaCarbonCredit')
            ->get();

        return view('carbon_credit.my_purchases', compact('purchases'));
    }
